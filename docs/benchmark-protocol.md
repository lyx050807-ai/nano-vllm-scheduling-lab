...
## Formal trace hash registry (BENCH-002)

The frozen recipe was materialized and independently regenerated byte-for-byte
on 2026-09-20. Each package has 60 requests and 20 per class. These exact
trace/sidecar pairs are the only `formal-mixed-v1` comparison inputs:

| Seed | Trace package | Trace SHA256 | Sidecar SHA256 |
| --- | --- | --- | --- |
| 101 | `workloads/formal_trace_seed101.jsonl` | `ff3acfd57a153030e76d06af491fed20bd1498db7e12580db345c8bb1ff92ac8` | `fb298e8ba8019d86e54c62487eb5906e0a59d9889ca5ca73881560f53e0b1476` |
| 202 | `workloads/formal_trace_seed202.jsonl` | `e3c82a96d5b7295b7e98d4d4884476ddd9cc5ee1701831f4d5e63e8872e94078` | `8603718474005a5dc3f18fac2b76cd4e37d23252dd19ea124c5f34734d95ebfc` |
| 303 | `workloads/formal_trace_seed303.jsonl` | `8721930601de3f96d23287cef9038a0967f653133987a154ca18ae8e5b4d6866` | `af6d5affaf40cbd7e72a0961d37d10dcdbe59664ce8a563e954ec844862d4526` |
